...
# ╔═╡ 94f03687-104f-48de-9f6c-deb0612b2bad
begin 
...
# ╔═╡ 946dc339-29b5-434f-92f7-f80a8574f4aa
CairoMakie.activate!()

# ╔═╡ 9ec59f54-cc79-11ec-38b0-7583ee5c5a56
form = @formula(y ~ 1 + x * z);

# ╔═╡ 1c23093c-9f43-4035-a404-a76e3cb998f5
# intercept, x, z, x&z
beta = [1, 42, 27, 0.4];

# ╔═╡ 59bbffd4-4359-4367-a464-73138ea6937f
sig = 3.14;

# ╔═╡ 44fda788-256d-469c-9761-8489e023fd96
n = 100;

# ╔═╡ ce6f6d99-11d5-429e-9a5c-14fb96f2fff6
begin
...
# ╔═╡ 61d2abf9-4174-4f5b-8a0d-3401fcfbb2fc
m2 = lm(form, dat)
