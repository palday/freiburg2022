...
# ╔═╡ 09e98fd4-cc7f-11ec-2271-1b1a5b3b6502
begin 
...
# ╔═╡ 4c2b6178-048b-457c-a4eb-98dc4b2e7f9f
rng = MersenneTwister(42)

# ╔═╡ 47f950e6-5be7-476c-936e-d14ce3d1ea52
form = @formula(dv ~ 1 + x + (1+x|subj));

# ╔═╡ d9403642-4d32-4581-bf1d-bd82bdefdf12
beta = [1, 22]

# ╔═╡ d4126697-110b-4796-800b-d20f604c67fd
sig =  3.14 # try 3.14

# ╔═╡ 41a511f6-af1c-4da0-8dfc-b80cff9b9ede
n = 500 # try 100, 200, 500, 1000

# ╔═╡ bfd6199c-5791-4a44-9d9d-5fffbf9942ff
n_subj = 20

# ╔═╡ 7490dda6-561b-4706-a17f-68a7e0cb2abf
subj_sd = [1.7, 1.414]

# ╔═╡ 61560387-8030-41da-ac06-074d8ff852a6
contrasts = Dict(:subj => Grouping())

# ╔═╡ ca8baeeb-b6a5-4154-b3a3-2ec95f0543fb
begin
	dat = DataFrame(simdat_crossed(rng, n_subj; 
					 both_win=Dict(:x => 20 * rand(rng, n) .- 10)))
	select!(dat, Not(:item))
	ground_truth = LinearMixedModel(form, dat; contrasts)
	MixedModelsSim.update!(ground_truth; subj=create_re(subj_sd...));
end;

# ╔═╡ 5dccf3ab-62dd-4556-a63e-389a74a30c35
nsims = 500

# ╔═╡ 33b1dfdf-a42a-4f8f-8c67-c988a7a6044e
sim = parametricbootstrap(rng, nsims, ground_truth; β=beta, σ=sig, use_threads=false)

# ╔═╡ 8098965d-7dd2-4f37-a18b-11ff44b5d952
...
GLM = "~1.7.0"
MixedModels = "~4.6.3"
MixedModelsExtras = "~0.1.4"
MixedModelsMakie = "~0.3.13"
MixedModelsSim = "~0.2.6"
StandardizedPredictors = "~0.1.4"
StatsModels = "~0.6.30"
"""
...
git-tree-sha1 = "6139d8869d7ae353efebf9576a3205b8e540f6aa"
...
git-tree-sha1 = "00ae93cdbad8e9b260379758cb6449e54e5f0ea5"
...
[[deps.StandardizedPredictors]]
deps = ["Statistics", "StatsBase", "StatsModels"]
git-tree-sha1 = "ad703fc1194d3e34173da500919b57f02c6acc7e"
